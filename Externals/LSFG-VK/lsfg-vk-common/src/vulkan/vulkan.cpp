...
#if defined(__SWITCH__) && defined(VK_NO_PROTOTYPES)
// Dolphin's Vulkan loader owns this process-global function pointer.  LSFG's
// standalone-device path is not used by the borrowed-device bridge, but keep
// it link-compatible instead of declaring the identically named Vulkan
// function when the whole Switch build is merged by LTO.
