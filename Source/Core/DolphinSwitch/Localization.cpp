...
constexpr std::array LAUNCHER_TRANSLATIONS = {
    ...
    LauncherTranslation{"Continue", "Continuer", "Weiter", "Continuar", "Continua",
                        "Continuar"},
    LauncherTranslation{"General", "Général", "Allgemein", "General", "Generale", "Geral"},
    LauncherTranslation{"Emulator", "Émulateur", "Emulator", "Emulador", "Emulatore",
                        "Emulador"},
    LauncherTranslation{"Library", "Bibliothèque", "Bibliothek", "Biblioteca", "Libreria",
                        "Biblioteca"},
    LauncherTranslation{"Manage game", "Gestion du jeu", "Spiel verwalten", "Gestionar juego",
                        "Gestisci gioco", "Gerir jogo"},
    LauncherTranslation{"Game menu", "Menu du jeu", "Spielmenü", "Menú del juego",
                        "Menu del gioco", "Menu do jogo"},
    LauncherTranslation{"Preview unavailable", "Aperçu indisponible",
                        "Vorschau nicht verfügbar", "Vista previa no disponible",
                        "Anteprima non disponibile", "Pré-visualização indisponível"},
    LauncherTranslation{"Use icon", "Utiliser l'icône", "Symbol verwenden", "Usar icono",
                        "Usa icona", "Usar ícone"},
    LauncherTranslation{"Scanned recursively", "Analyse récursive", "Rekursiv durchsucht",
                        "Análisis recursivo", "Scansione ricorsiva", "Análise recursiva"},
    LauncherTranslation{"folder", "dossier", "Ordner", "carpeta", "cartella", "pasta"},
    LauncherTranslation{"folders", "dossiers", "Ordner", "carpetas", "cartelle", "pastas"},
    LauncherTranslation{"saved share", "partage enregistré", "gespeicherte Freigabe",
                        "recurso guardado", "condivisione salvata", "partilha guardada"},
    LauncherTranslation{"saved shares", "partages enregistrés", "gespeicherte Freigaben",
                        "recursos guardados", "condivisioni salvate", "partilhas guardadas"},
    LauncherTranslation{"(no icon)", "(aucune icône)", "(kein Symbol)", "(sin icono)",
                        "(nessuna icona)", "(sem ícone)"},
