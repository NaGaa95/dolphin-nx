...
// Dolphin-specific modifications are licensed under ISC as permitted by the original license.
#include <switch.h>
#include <string.h>

#define EXIT_DETECTION_STR "__DOLPHIN_FORWARDER_EXIT__"
#ifndef FWD_CFG_DIR
#define FWD_CFG_DIR "/switch/dolphin/forwarders/"
#endif
...
static const char g_noticeText[] = { "Dolphin " VERSION };
